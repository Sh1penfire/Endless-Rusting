...
public class RigidRepalcement {
    ...
    static double gradientNoise3D(double fx, double fy, double fz, int ix, int iy, int iz, int seed){
        ...
        double xvGradient = ReplicaVectorTable.randomVectors[vectorIndex];
        double yvGradient = ReplicaVectorTable.randomVectors[vectorIndex + 1];
        double zvGradient = ReplicaVectorTable.randomVectors[vectorIndex + 2];

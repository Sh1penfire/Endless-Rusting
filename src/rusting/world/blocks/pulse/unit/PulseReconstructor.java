...
public class PulseReconstructor extends PulseUnitBlock{
    public float constructTime = 60 * 2;
    public Seq<UnitType[]> upgrades = new Seq<>();
    public int[] capacities = {};

    public PulseReconstructor(String name){
        super(name);
    }
    ...
    public void setBars(){
        ...
        bars.add("progress", (PulseReconstructorBuild entity) -> new Bar("bar.progress", Pal.ammo, entity::fraction));
        bars.add("units", (PulseReconstructorBuild e) ->
                new Bar(
    ...
    public class PulseReconstructorBuild extends PulseUnitBuild{
